...
module.exports = function(){
	...
	function sqlMakeNewShot(shot){
		if (config.database.enabled){
			mysql.query("INSERT INTO shot (ring, ringValue, teiler, x, y, winkel, date, number, sessionID) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?);",
				[shot.ring.display, shot.ring.value, shot.teiler, shot.x, shot.y, shot.winkel, shot.time, shot.number, sqlVars.sessionID],
