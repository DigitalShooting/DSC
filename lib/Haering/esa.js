...
module.exports = function(interf, disziplin){
	...
	esa.band = function(){
		exec([__dirname+"/bin/HaeringAPI", interf.com, "band", disziplin.interface.band.onChangePart], function(err, out, code) {
	...
	esa.set = function(){
		exec([__dirname+"/bin/HaeringAPI", interf.com, "set", disziplin.interface.band.onShot], function(err, out, code) {
