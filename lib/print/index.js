...
var templates = {
	default: __dirname+"/templates/default.jade",
	dateless: __dirname+"/templates/dateless.jade",
	bigImage: __dirname+"/templates/bigImage.jade",
};
...
module.exports = function(data, templateName, callback){
	...
	// Compile a function
	var fn = ( jade.compile(fs.readFileSync(template, "utf8"), {}) );
